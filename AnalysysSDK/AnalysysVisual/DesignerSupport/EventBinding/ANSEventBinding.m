...
{
    [[ANSVisualSDK sharedManager] trackEventID:eventBinding.eventName trackView:object withProperties:nil];
}
...
- (instancetype)initWithEventBindingInfo:(NSDictionary *)bindingInfo
{
    if (self = [super init]) {
        ...
        self.associated_path = [[ANSObjectSelector alloc] initWithPathString:bindingInfo[@"associated_path"]?:@""];
