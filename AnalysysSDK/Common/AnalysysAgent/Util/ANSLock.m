...
+ (dispatch_semaphore_t)ans_visual_semaphore_lock {
    static dispatch_semaphore_t ans_visual_semaphore_lock;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        ans_visual_semaphore_lock = dispatch_semaphore_create(1);
    });
    return ans_visual_semaphore_lock;
}
