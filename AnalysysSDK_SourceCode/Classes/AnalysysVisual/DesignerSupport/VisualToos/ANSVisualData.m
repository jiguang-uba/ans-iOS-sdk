...
+ (void)setViewClickableMap:(NSDictionary * _Nonnull)map {
    [ANSVisualData sharedManager].rct_viewMap = [NSDictionary dictionaryWithDictionary:map];
//    NSLog(@"rct_viewMap : %@",[ANSVisualData sharedManager].rct_viewMap);
}
@end
