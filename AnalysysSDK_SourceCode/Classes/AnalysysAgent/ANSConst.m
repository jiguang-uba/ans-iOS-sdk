...
NSString *const ANSSDKVersion = @"4.5.20.3";
...
NSString *const ANSUtmActionType = @"$action_type";
...
#pragma mark - 页面时长
NSString *const ANSPage_close = @"page_close";
NSString *const ANSPageStayTime = @"pageStayTime";
